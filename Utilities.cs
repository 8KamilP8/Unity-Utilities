...
namespace Utilities {
    ...
    public static class UtilFunc {
        ...
        /// <summary>
        /// Gets Random direction between two angles, angles should be passed in radians
        /// </summary>
        ...
        public static Vector2 GetRandomDirectionInRange(float angleA,float angleB) {
            ...
            return GenerateDirectionFromAngle(RandomBetween(angleA,angleB));
        }
        ...
        public static Vector2 GetRandomVector2(float length) {
            return GetRandomDirection() * length;
        }
        public static Vector2 GetRandomPosition(Vector2 center, float radius) {
            return center + GetRandomDirection() * RandomBetween(0f, radius);
        }
        ...
        public static Vector2 GetRandomPosition(Rectangle r) {
